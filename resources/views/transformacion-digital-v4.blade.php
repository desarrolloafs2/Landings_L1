    ...
    <body>
        ...
        <section class="mb-5 text-center">
            <div class="container">
                <div class="col-12 mx-auto">
                    <h1 class="my-5 mb-5" 
                        style="font-size: 4rem; font-weight: 900; line-height: 1.2; color: #555;">
        ...
        <section class="mb-5 bg-section text-center" 
            ...
            <div class="container position-relative">
                <div class="mx-auto" style="max-width: 90%;"> 
                    ...
                    <p class="text-white" 
                        style="font-size: 1.6rem; margin-bottom: 7rem;">
                    ...
                    <div class="row mb-5" style="gap: 1.5rem 0;">
                        <div class="col-6">
                            <div style="font-size: 1.3rem; background: white; border-radius: 10px; padding: 1.2rem; text-align: center;">
        ...
        <section class="py-5">
            <div class="container-fluid py-5">
                ...
                <div style="background-color: #e0ddddff; border-radius: 16px; padding: 3rem; max-width: 90%; margin: 0 auto;  color: #555;">
                    ...
                    <div class="row" style="display: flex; align-items: center; justify-content: space-between;">
                        ...
                        <div class="col-md-7 col-12 ms-auto" style="margin-right: -5rem;">
                            <div class="row mb-4 justify-content-center" style="gap: 1rem;">
                                <div class="col-5">
                                    <div style="background: white; border-radius: 12px; padding: 8rem 0.5rem; text-align: center; font-size: 1.6rem;">
                            ...
                            <div class="row my-5 py-5 align-items-stretch">
                                ...
                                <div class="col-xl-6 col-lg-5 col-12 mb-5 d-flex">
                                    <div class="container-fluid bg-transparent-black" style="height: 120%; border-radius: 25px;">
                                        <div class="row h-100">
                                            <div class="col-lg-10 offset-lg-1 col-12 offset-0 d-flex flex-column justify-content-center">
                                                <h1 class="text-white" style="font-size: 4rem;"><b>¿Quieres<br>estudiar y no<br>sabes qué?</b></h1>
                                                <h4 class="text-white mt-4" style="font-size: 2.7rem;">Rellena el formulario<br>y te ayudamos</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="fields">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" id="current-position" name="current_position" required>
                                                                ...
                                                                <option value="CF">CF Grado Medio/CF Grado Superior/FP II/Bachiller/COU/Acceso Cliclo Superiror/Competencias clave 3</option>
                        ...
                        <div class="accordion" id="faqAccordion">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Sí. Todos nuestros cursos están 100% subvencionados por el Ministerio de Educación, Formación Profesional y Deportes, por lo que no tienen ningún coste para el alumnado.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        En casi todos los cursos sí. Los certificados de profesionalidad incluyen un <b>módulo obligatorio de prácticas (FCT)</b> en empresas del sector, lo que permite poner en práctica lo aprendido y ganar experiencia real. En algunos cursos más cortos o específicos no hay prácticas, pero siempre te lo indicamos claramente en la información de cada curso.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Depende del curso. Algunos certificados requieren un nivel académico mínimo, pero muchos están abiertos sin necesidad de formación previa. En cada curso encontrarás los requisitos específicos.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Solo tienes que buscar el curso que más te interese en el listado de nuestra web y entrar en su ficha. Allí encontrarás un formulario de preinscripción para rellenar con tus datos. Una vez recibamos tu solicitud, nuestro equipo se pondrá en contacto contigo para confirmar tu plaza y explicarte los siguientes pasos.
                                    </div>
                                </div>
                            </div>
